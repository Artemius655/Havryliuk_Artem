...
pr3=Radiobutton (labuba, text="шоколадна присипка", variable=prap3, onvalue=1, offvalue=0)
pr3.place (x=100, y=200)
pr4=Radiobutton (labuba, onvalue=1, offvalue=0, text="кокосова стружка", variable=prap4,)
