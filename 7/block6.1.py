...
prapor1=Radiobutton (Window, text="Жовтий", variable=prap1, onvalue=1, offvalue=0)
prapor1.place ( x = 100 , y = 100 )
prapor2=Radiobutton (Window, onvalue=1, offvalue=0, text="Зелений", variable=prap2,)
prapor2.place ( x = 100 , y = 120 )
prapor3=Radiobutton(Window, text="Акварель ", variable=prap3, onvalue=1, offvalue=0)
prapor3.place (x=100, y=160)
prapor4=Radiobutton (Window, onvalue=1, offvalue=0, text="Гуаш", variable=prap4,)
